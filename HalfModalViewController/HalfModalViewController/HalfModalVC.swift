...
class HalfPageModalViewController: UIViewController {
    ...
    /**
        The dimmed view on top of the containerView.
     */
    ...
    */
    ...
    private var containerViewHeightConstraint: NSLayoutConstraint?                       //Height constraint for the container
     ...
     */
    @objc private func dimmedViewTapped(gesture: UIPanGestureRecognizer){
        self.animateDismissView()
    }
}
